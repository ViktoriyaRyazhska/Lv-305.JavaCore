    ...
    public static void makeACall(int callCount){
        ...
        try{
            ...
            if(costPerMinnute.matches("\\d+\\.\\d+")||costPerMinnute.matches("\\d+")){
                ...
                System.out.println("Invalid data (call cost per minute). Can not make a call"); return;
            }
           ...
           talkDuration=reader.readLine();
            if(talkDuration.matches("\\d+")){
                ...
                if(td==0){
                    System.out.println("Canceled call");return;
                }
            }
            else {
                System.out.println("Invalid data (call duration). Can not make a call"); return;
            }
