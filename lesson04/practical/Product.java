...
public class Product implements Comparable<Product>{
    ...
    public static void main(String[] args) {
        //can not resolve problem with adding collection to Stream.of();
        Product[] products = {
                new Product("Apple",12.0,30),
                new Product("Pear",22.3,50),
                new Product("Lemon",20.5,18),
                new Product("Peach",35.8,24)};
